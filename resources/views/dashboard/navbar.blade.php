        ...
        <ul class="nav navbar-nav @if (config('voyager.multilingual.rtl')) navbar-left @else navbar-right @endif">
            <li class="dropdown profile">
                <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button"
                   aria-expanded="false"><img src="{{ voyager_asset('images/default.png') }}" class="profile-img"> <span
                            class="caret"></span></a>
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li class="profile-img">
                        <img src="{{ voyager_asset('images/default.png') }}" class="profile-img">
                        <div class="profile-body">
                            <h5>{{ cas()->user() }}</h5>
                            <h6>{{ cas()->getAttribute('email') }}</h6>
                        </div>
                    </li>
                    <li class="divider"></li>
