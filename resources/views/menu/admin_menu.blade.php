    ...
    @foreach ($items as $item)
        @php
            ...
            if(!$item->children->isEmpty())
            {
                ...
                {
                    $hasChildren = $hasChildren || \CHG\Voyager\Facades\Voyager::can('browse' . "_" . explode(".", $child->route)[1]);
            ...
            else
            {
                ...
                if(!\CHG\Voyager\Facades\Voyager::can('browse' . "_" . explode(".", $item->route)[1])) {
                    continue;
                }
            }
        @endphp
